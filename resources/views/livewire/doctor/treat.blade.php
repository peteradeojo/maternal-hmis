<div>
    ...
    <div class="py-2 grid grid-cols-3 gap-x-2">
        ...
        <div>
            <div class="flex-center gap-x-4 pb-2">
                ...
                <button @click="$dispatch('open-t-complaints-modal')" class="px-1 py-0.5 btn-blue text-white"><i
        ...
        <div>
            <div class="flex-center gap-x-4 pb-2">
                ...
                <button class="px-1 py-0.5 btn-blue" data-target="#anc-visit-notes-modal"
                    @click="$dispatch('open-t-notes-modal')">
        ...
        <div>
            <div class="flex-center gap-x-4 pb-2">
                <p class="text-xl bold">Diagnoses</p>
                {{-- <button class="px-1 py-0.5 btn-blue" data-target="#anc-visit-notes-modal"
                    @click="$dispatch('open-t-diagnosis')">
                    <i class="fa fa-pen"></i>
                </button> --}}
            </div>
            ...
            <div>
                @forelse ($visit->diagnoses as $note)
                    <div class="bg-gray-100 p-2">
                        <p>{{ $note->diagnoses }}</p>
                        <p class="text-xs">Consultant: {{ $note->consultant->name }}</p>
                ...
                @empty
                    <p class="py-1">No diagnosis added.</p>
                @endforelse
            </div>
        </div>
    </div>
    ...
    <div class="grid grid-cols-2 gap-4 items-start">
        ...
        <div class="p-2 border border-black" x-data="{ open: true }">
            <div class="flex-center hover:bg-gray-50 gap-x-4 p-2" @click="$dispatch('open-t-prescriptions')">
