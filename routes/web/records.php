...
Route::name('records.')->prefix('/records')->middleware(['role:record|admin', 'datalog'])->group(function () {
    ...
    Route::post('/antenatal/new/{patient}', [Antenatal::class, 'create'])->name('new-anc');

    Route::match(['GET', 'DELETE'], '/antenatal/{profile}/close', [Antenatal::class, 'closeProfile'])->name('close-anc');
